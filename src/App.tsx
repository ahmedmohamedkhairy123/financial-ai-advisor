...
import { AIAnalysisResult } from './types'; // Import the type
        ...
        <Route path="/" element={
          <div className="min-h-screen flex flex-col bg-slate-50 font-sans text-slate-800">
            ...
            <main className="flex-grow container mx-auto px-4 py-8 max-w-3xl">
              ...
              <FinancialForm 
                onAnalysisComplete={(analysisResult: any) => {
                  // Assuming analysisResult has data and sessionId properties
                  setResult(analysisResult.data || analysisResult);
