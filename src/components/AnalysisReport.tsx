...
import ExportButtons from './export/ExportButtons'; // ✅ ADDED
...
export const AnalysisReport: React.FC<AnalysisReportProps> = ({ data, onReset, sessionId }) => {
  ...
  return (
    <div className="animate-fade-in max-w-5xl mx-auto space-y-8 pb-12">
      ...
      <div className={`p-6 rounded-xl border-l-8 shadow-sm ${
        data.feasibilityColor === FeasibilityStatus.RED ? 'bg-red-50 border-red-500' :
      ...
      {/* ✅ EXPORT BUTTONS SECTION - ADDED */}
      <ExportButtons sessionId={sessionId} analysisData={data} />
